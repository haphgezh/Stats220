...
paste("The average drink amount consumed is", round(mean_value, 2), "units.")
paste("The smallest recorded drink amount is", min_value, "units.")
paste("The largest recorded drink amount is", max_value, "units.")
